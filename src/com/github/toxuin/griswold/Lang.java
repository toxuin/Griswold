...
public class Lang {
    ...
    public static void createLangFile() {
        ...
        if (!langFile.exists()) {
            ...
            language.set("insufficient_params",
                    "Please add more parameters! Usage: " + ChatColor.BLUE + "/blacksmith create " + ChatColor.GREEN +
                    "name " + ChatColor.GRAY + "type cost");
            ...
            language.set("chat_type_error",
                    "Whoops, wrong repairman type! Possiable are: tools, armor, both, enchant, all");
            ...
            language.set("chat_enchant_free",
                    "This item is fully repaired, though I can enchant it - for free of course.");
            ...
            language.set("chat_noitem",
                    ChatColor.AQUA + "*Shakes your hand*" + ChatColor.WHITE + " Hello! Glad to meet you!");
